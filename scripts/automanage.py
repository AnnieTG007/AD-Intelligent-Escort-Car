...
sys.path.append('/home/pi/projects') #添加树莓派中donkeycar的环境路径
...
origin_cfg = dk.load_config(myconfig='myconfig.py')  #调用myconfig.py中的自定义设置
origin_path = '/home/pi/mycar/models/follow.h5'  #调用manage.py 传参模型路径

def drive(cfg=origin_cfg, model_path=origin_path, use_joystick=False, model_type=origin_cfg.DEFAULT_MODEL_TYPE, camera_type='single', meta=[]):
    '''
